...
<html>
  <head>
    ...
    <script src="/script/utf8.js"></script>
      ...
      <script type="text/javascript" src="/script/rutoken.js"></script>
      <script type="text/javascript" src="/script/bowser.js"></script>
      <script type="text/javascript" src="/script/rutoken_browser_check.js"></script>
      <script type="text/javascript" src="/script/samplePinResolver.js"></script>
      <script src="/script/boot.js"></script>
      <script src="/script/rtwToCrypto.js"></script>
    <!--[if lt IE 9]>
...
function addOption (oListbox, text, value, isDefaultSelected, isSelected) {
  ...
  oListbox.appendChild(oOption);
    ...
    <footer class="footer">
      <dl>
        <dt>1994 — <?php echo  date("Y"); ?> © <a href="http://www.aktiv-company.ru/" target="_blank"><span>Компания «Актив»</span></a></dt>
